...
description: 'Guidelines and best practices for contributing to the Definable backend codebase'
---

This guide outlines the coding standards and best practices for the Definable backend codebase. Following these standards ensures code consistency, maintainability, and quality across the project.
