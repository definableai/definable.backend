---
title: 'Definable Backend Overview'
description: 'Understanding the Definable AI platform architecture and capabilities'
---

The Definable backend is a powerful, scalable system designed to provide AI-driven knowledge base and conversation capabilities. Built with modern asynchronous Python, the platform leverages FastAPI, PostgreSQL with vector extensions, and integrates with leading LLM providers.
...
Definable follows a modular, service-oriented architecture built with FastAPI:
...
To get started with the Definable backend:
