...
description: 'Understanding the middleware architecture in the Definable backend'
---
...
Middlewares in Definable provide a powerful mechanism for implementing cross-cutting concerns that apply to all API requests. They are automatically discovered and registered, making the architecture extensible and maintainable.
