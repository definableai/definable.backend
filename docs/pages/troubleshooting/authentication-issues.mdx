...
description: 'Troubleshooting JWT, RBAC, and user authentication problems in the Definable backend'
---
...
<Accordion title="Token security with Definable's implementation">
  **Symptoms:**
