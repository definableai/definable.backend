...
class TestToolServiceEdgeCases:
    ...
    async def test_create_tool_with_invalid_generator(self, tools_service, mock_db_session, test_user, test_organization, sample_tool_create_data, mock_category):
