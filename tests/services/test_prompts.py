...
class MockPromptCategoryModel:
    def __init__(self, model_id=None, name="Test Category", description="Test description",
                 icon_url="https://example.com/icon.png", display_order=1, is_active=True, **kwargs):
...
class MockPromptModel:
    def __init__(self, model_id=None, title="Test Prompt", content="This is a test prompt",
    ...
    async def test_public_prompts_integration(self, prompt_service, db_session, test_integration_user, setup_test_db_integration):
        ...
        async for session in db_session:
            try:
                ...
                # Cleanup prompts
                all_prompts = await prompt_service.get_list_pagination(
                    org_id=test_integration_user["org_id"],
                    session=session,
                    user=test_integration_user
                )
