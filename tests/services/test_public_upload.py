...
class TestPublicUploadServiceIntegration:
    ...
    async def test_upload_file_integration(self, integration_upload_service, db_session, test_integration_user, test_upload_file, setup_test_db_integration):
    ...
    async def test_upload_with_metadata_integration(self, integration_upload_service, db_session, test_integration_user, test_upload_file, setup_test_db_integration):
    ...
    async def test_upload_and_retrieve_integration(self, integration_upload_service, db_session, test_integration_user, test_upload_file, setup_test_db_integration):
    ...
    async def test_upload_custom_path_integration(self, integration_upload_service, db_session, test_integration_user, test_upload_file, setup_test_db_integration):
    ...
    async def test_upload_delete_integration(self, integration_upload_service, db_session, test_integration_user, test_upload_file, setup_test_db_integration):
