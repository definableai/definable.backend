...
class TestGenerateLegacy:
  ...
  def test_generate_toolkit_with_custom_class_name(self, tool_generator):
    ...
    json_data = {
      "info": {"name": "CustomName", "version": "1", "description": "A custom tool"},
      "function_info": {"name": "run", "is_async": False, "description": "Run the tool", "code": "def run(self): return 'Hello'"},
    }
  ...
  def test_generate_toolkit_with_configuration(self, tool_generator):
    ...
    json_data = {
      "info": {"name": "ConfigTool", "version": "1", "description": "A tool with configuration"},
      "function_info": {"name": "run", "is_async": False, "description": "Run the tool", "code": "def run(self): return 'Hello'"},
      "configuration": [
