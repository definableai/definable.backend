...
class TestFirecrawl:
  ...
  def test_scrape_url_success(self, mock_scrape_url):
    ...
    mock_scrape_url.return_value = {"markdown": expected_markdown, "metadata": {"statusCode": 200}}
  ...
  def test_scrape_url_failure(self, mock_scrape_url):
    ...
    # Setup mock
    mock_scrape_url.return_value = {"markdown": "", "metadata": {"statusCode": 404}}
  ...
  async def test_crawl_success(self, mock_post):
    ...
    # Setup mock
    expected_response = {"crawl_id": "test-crawl-id", "status": "started", "message": "Crawl started successfully"}
    ...
    # Execute
    test_url = "https://example.com"
    test_params = {"limit": 10, "exclude_paths": ["/admin"], "callbacks": {"on_document": "http://localhost:8000/callback"}}
  ...
  async def test_get_crawl_status(self, mock_check_status):
    ...
    # Setup mock
    expected_status = {"crawl_id": "test-crawl-id", "status": "completed", "urls_processed": 10, "urls_failed": 0}
