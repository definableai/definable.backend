...
from libs.definable.embedder.base import Embedder
from libs.definable.embedder.openai import OpenAIEmbedder
...
class SemanticChunking(ChunkingStrategy):
  ...
  def __init__(self, embedder: Optional[Embedder] = None, chunk_size: int = 5000, similarity_threshold: Optional[float] = 0.5):
