...
class IntentAnalysisService:
  ...
  def __init__(self):
    ...
    self.system_prompt = (
      "You are an expert intent analysis AI. Your job is to analyze user messages and "
      "determine if they want to generate an image or have a normal conversation.\\n\\n"
...
0.80"""
      ...
      agent = Agent(
        model=DeepSeek(id="deepseek-chat", api_key=settings.deepseek_api_key, temperature=0.1, max_tokens=20),
